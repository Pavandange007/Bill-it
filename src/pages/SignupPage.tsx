    ...
    <div className="min-h-dvh bg-zinc-50 text-zinc-900">
      <div className="mx-auto grid max-w-md place-items-center px-4 py-10">
        <div className="w-full rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-1 text-sm text-zinc-600">Sign up to access the POS.</div>
          ...
          >
            ...
            <label className="block">
              <div className="mb-1 text-xs font-semibold text-zinc-700">Password (min 8 chars)</div>
              <input
                type="password"
                value={password}
          ...
          <div className="mt-4 text-sm text-zinc-600">
            ...
            <Link to="/login" className="font-semibold text-zinc-900 underline underline-offset-4">
              Login
            </Link>
          </div>
        </div>
